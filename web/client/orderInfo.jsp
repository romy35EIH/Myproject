									...
									<tr>
										<td>
											...
											<c:forEach items="${order.Items}" var="item" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%">${item.salenum }</td>
														<td width="10%">${item.salenum*item.p.price }</td>
													</tr>
												</table>
											</c:forEach>
											<table cellspacing="1" class="carttable">
												<tr>
													<td style="text-align:right; padding-right:40px;"><font
														style="color:#FF0000">合计：&nbsp;&nbsp;${order.price}</font>
													</td>
												</tr>
											</table>
											<p>
											...
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath}/client/pay.jsp?id=${order.id}&price=${order.price}">
