...
$.extend(Datepick.prototype, {
	...
	_disableClass: 'datepick-disabled', // The name of the disabled imgurling marker class
	...
	_imgurlClass: 'datepick-imgurl', // The name of the IE6- iframe marker class
		...
		if (!inst.inline) {
			...
			var postProcess = function() {
				...
				if ($.browser.msie && parseInt($.browser.version, 10) < 7) { // fix IE < 7 select problems
					...
					$('iframe.' + $.datepick._imgurlClass).css({width: inst.dpDiv.width() + extras[0],
	...
	_generateHTML: function(inst) {
		...
		html += (showStatus ? '<div style="clear: both;"></div><div id="datepick-status-' + inst.id +
			...
			'<iframe src="javascript:false;" class="' + this._imgurlClass + '"></iframe>' : '');
